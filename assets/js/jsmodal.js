...
$(".pop-right").click(function () {
	...
	$(".modal-right .modal-body").html('<div class="row"><div class="text-center col-lg-12"><div class="spinner-border" role="status">  <span class="visually-hidden">Loading...</span></div><br/> Content loading, please wait...</div></div>');
...
$(".pop-left").click(function () {
	...
	$(".modal-left .modal-body").html('<div class="row"><div class="text-center col-lg-12"><div class="spinner-border" role="status">  <span class="visually-hidden">Loading...</span></div><br/> Content loading, please wait...</div></div>');
