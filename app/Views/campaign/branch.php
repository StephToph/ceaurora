                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Branch</h3>
                            <div class="nk-block-des text-soft">
                            <?php $all_rec = $this->Crud->filter_branch('', '', $log_id, '', '');
                                    if(!empty($all_rec)) { $counts = count($all_rec); } else { $counts = 0; }
                                    ?>
                                <p>You have total <?=$counts;?> Branch</p>
                            </div>
                                ...
                                <div class="toggle-expand-content" data-content="more-options">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <div class="drodown">
                                                <a href="javascript:;" class="btn btn-icon btn-lg btn-primary pop" pagetitle="Add" pagesize="modal-sm" pagename="<?=site_url('product/branch/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>   
                                            </div>
                                        </li>
                                        <li>
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'product/branch/load' + methods,
            type: 'post',
