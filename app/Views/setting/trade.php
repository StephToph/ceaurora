                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Trade Line</h3>
                                <div class="nk-block-des text-soft">
                                    <p>Manage Business Trade Line</p>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li class="nk-block-tools-opt">
                                                <a href="javascript:;" class="float-right btn btn-primary pop" pageTitle="Add Trade Line" pageName="<?php echo base_url('settings/trade/manage'); ?>" pageSize="">
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'settings/trade/load' + methods,
            type: 'post',
            data: {  search: search },
