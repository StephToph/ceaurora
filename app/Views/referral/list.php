                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between ">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Referral');?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('Total of');?> <span id="counta">0</span> <?=translate_phrase('referrals'); ?>.</p>
                            </div>
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'referral/list/load' + methods,
            type: 'post',
