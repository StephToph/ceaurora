                ...
                <div class="nk-block-head nk-block-head-sm  mt-3">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Field Operative'); ?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total'); ?> <span id="counta"></span> <?=translate_phrase('field operative(s).');?></p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <a href="javascript:;" class="float-right btn btn-primary pop" pageTitle="Add Field Operative" pageName="<?php echo base_url('accounts/field/manage'); ?>" pageSize="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12"> 
                                                            <select class="form-select js-select2" data-search="on" id="territory" name="territory" onchange="load();">
                                                                <option value="all"><?=translate_phrase('Filter Territory'); ?></option>
                                                                <?php $states = $this->Crud->read_order('territory', 'name', 'asc');
                                                                    foreach($states as $s) {
                                                                        $s_sel = '';
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'accounts/field/load' + methods,
            type: 'post',
