            ...
            <div class="nk-content-body mt-3">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        ...
                        <div class="nk-block-head-content">
                            <a href="<?=site_url('accounts/business'); ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span><?=translate_phrase('Back');?></span></a>
                            <a href="<?=site_url('accounts/business'); ?>" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                        </div>
                    </div>
                                        ...
                                        <div class="tab-pane active" id="personal-info">
                                            <div class="nk-block">
                                                ...
                                                <div class="profile-ud-list">
                                                    ...
                                                    <div class="profile-ud-item">
                                                        <div class="profile-ud wider">
                                                            <span class="profile-ud-label"><?=translate_phrase('Business Name');?></span>
                                                            <span class="profile-ud-value"><?=ucwords($v_business_name); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-ud-item">
                                                        <div class="profile-ud wider">
                                                            <span class="profile-ud-label"><?=translate_phrase('Business Address');?></span>
                                                            <span class="profile-ud-value"><?=ucwords($v_business_address); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-ud-item">
                                                        <div class="profile-ud wider">
                                                                ...
                                                                <div class="nk-wgw sm">
                                                                    <a class="nk-wgw-inner mb-3 pb-1" href="javascript:;">
                                                                        ...
                                                                        <div class="nk-wgw-balance ">
                                                                            ...
                                                                            ?>
                                                                            <div class="amount text-white">&#8358;<?=number_format($balance, 2);?></div>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <div class="nk-wgw-balance ">
                                                                            <?php
                                                                                ...
                                                                                if(!empty($query)) {
                                                                                    ...
                                                                                    $dep_balance = $earnings;
                                                                                }
                                                                            ?>
                                                                            <div class="amount text-white">&#8358;<?=number_format($dep_balance, 2);?></div>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                            </div>
