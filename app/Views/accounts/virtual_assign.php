                ...
                <div class="nk-block-head nk-block-head-sm  mt-3">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Virtual Assign'); ?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total'); ?> <span id="counta"></span> <?=translate_phrase('virtual assign.');?></p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <a href="javascript:;" class="float-right btn btn-primary pop" pageTitle="Generate" pageName="<?php echo site_url('accounts/virtual_assign/manage/generate'); ?>" pageSize="modal-sm">
                                                <em class="icon ni ni-plus-sm"></em> Generate Tax ID
                                            </a>
                                        </li>
                                    </ul>
                                </div>
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'accounts/virtual_assign/load' + methods,
            type: 'post',
