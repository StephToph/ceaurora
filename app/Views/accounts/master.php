                ...
                <div class="nk-block-head nk-block-head-sm  mt-3">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Tax Master'); ?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total'); ?> <span id="counta"></span> <?=translate_phrase('tax master(s).');?></p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <a href="javascript:;" class="float-right btn btn-primary pop" pageTitle="Add Task master" pageName="<?php echo base_url('accounts/master/manage'); ?>" pageSize="">
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'accounts/master/load' + methods,
            type: 'post',
