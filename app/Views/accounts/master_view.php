            ...
            <div class="nk-content-body mt-3">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        ...
                        <div class="nk-block-head-content">
                            <a href="<?=site_url('accounts/master'); ?>" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span><?=translate_phrase('Back');?></span></a>
                            <a href="<?=site_url('accounts/master'); ?>" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                        </div>
                    </div>
